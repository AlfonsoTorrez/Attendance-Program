'''
    Program Name: Testing OpenCV
    Contributors: Alfonso Torres, Jaime Velazquez
    Course: CST 205
    Objective: Our plan was to work with OpenCV and face recognition. The algorithm we ended up using for
               face recognition was LBPH (Local Binary Patterns Histogram). We settled with this algorithm since it
               gave use the best results. This piece of code is able to gather data and broadcast a video. It uses
               the data in the video to determine how many times someone has gone to a certain area.x
'''
...
#Testing your program
    ...
    #Predicting an image
    #Printed names above show the correct names of the people
...
#Deleting user information
    ...
    while x :
        print(my_info)
        #MAKE sure to delete images from faces that correspond to the user info you deleted
